...
// A lightweight WebRTC service with lazy initialization for better performance
class WebRTCService {
  ...
  Future<bool> initialize(String userId) async {
    ...
    if (_isWebPlatform && !web.shouldInitializeService('webrtc')) {
      LoggingService.info('WebRTC service initialization skipped on web platform', 'WebRTC');
      return false;
    }
